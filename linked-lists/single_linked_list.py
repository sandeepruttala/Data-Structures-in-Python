...
class Linkedlist:
    ...
    def delete(self, key):
        ...
        if temp is None:  # if the key is not present in the linked list
            return
    ...
    def delete_position(self, position):
        ...
        if temp.next is None:  # if the position is more than the number of nodes
            return
        next_node = temp.next.next  # assign the next node of the node to be deleted to a variable
        temp.next = None  # set the next node of the node to be deleted to None
        temp.next = next_node  # set the next node of the previous node to the next node of the node to be deleted
